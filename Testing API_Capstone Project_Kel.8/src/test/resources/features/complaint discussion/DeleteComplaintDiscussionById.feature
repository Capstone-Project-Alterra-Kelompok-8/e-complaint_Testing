Feature: Delete complaint discussion by ID
  ...
  So that I can see complaint discussion data has been delete
  ...
  #negative
  Scenario: As a admin I can't delete complaint discussion by ID with valid endpoint and wrong method
  ...
  #negative
  Scenario: As a admin I can't delete complaint discussion by ID with valid method and wrong endpoint
  ...
  Scenario: As a admin I can't delete complaint discussion by ID with invalid ID
    ...
    When I send a request to delete complaint discussion data by ID with invalid ID
