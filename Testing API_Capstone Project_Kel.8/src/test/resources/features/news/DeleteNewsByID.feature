Feature: Delete news by ID
  ...
  So that I can see news data has been delete
  ...
  #negative
  Scenario: As a admin I can't delete news by ID with valid endpoint and wrong method
  ...
  #negative
  Scenario: As a admin I can't delete news by ID with valid method and wrong endpoint
  ...
  Scenario: As a admin I can't delete news by ID with invalid ID
    ...
    When I send a request to delete news data by ID with invalid ID
    Then I received status code 400 bad request