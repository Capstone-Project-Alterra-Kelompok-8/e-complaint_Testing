...
public class AddNewUser {
    ...
    public void sendCreateUser() {
        ...
        requestBody.put("name", "Naruto Gagah");
        requestBody.put("email", "SARIPUDENvol2@gmail.com");
    ...
    public void receiveValidDataForNewUser() {
        ...
        restAssuredThat(response -> response.body("'data'.'name'", Matchers.equalTo("Naruto Gagah")));
        restAssuredThat(response -> response.body("'data'.'email'", Matchers.equalTo("SARIPUDENvol2@gmail.com")));
