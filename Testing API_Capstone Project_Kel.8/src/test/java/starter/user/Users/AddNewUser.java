...
public class AddNewUser {
    ...
    public void sendCreateUser() {
        ...
        requestBody.put("name", "Naruto Senior2");
        requestBody.put("email", "borutoboy2@gmail.com");
    ...
    public void receiveValidDataForNewUser() {
        ...
        restAssuredThat(response -> response.body("'data'.'name'", Matchers.equalTo("Naruto Senior2")));
        restAssuredThat(response -> response.body("'data'.'email'", Matchers.equalTo("borutoboy2@gmail.com")));
